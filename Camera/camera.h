...
class Camera {
public:
  Camera(s21::Vector3 position = s21::Vector3(0.0f, 0.0f, -3.0f), s21::Vector3 up = s21::Vector3(0.0f, 1.0f, 0.0f), float yaw = YAW, float pitch = PITCH) : m_front(s21::Vector3(0.0f, 0.0f, -1.0f)), m_movementSpeed(SPEED), m_mouseSensitivity(SENSITIVITY), m_zoom(ZOOM)
  {
      m_position = position;
      m_worldUp = up;
      m_yaw = yaw;
  ...
  s21::Matrix4x4 GetViewMatrix()
  {
      return s21::LookAt(m_position, m_position + m_front, m_up);
  }
